 ...
 */
package IkramulHamda_260423.view;

import IkramulHamda_260423.controller.AnggotaController;
...
public class FormAnggota extends javax.swing.JFrame {
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        if (txtNama.getText().trim().equals("") || txtNobp.getText().trim().equals("") || txtAlamat.getText().trim().equals(""))
        {
            JOptionPane.showMessageDialog(null,"Tidak boleh ada data yang kosong \n Input ulang");
        }else{
            model.addRow(new Object[]{txtNobp.getText(), txtNama.getText(), txtAlamat.getText()});
